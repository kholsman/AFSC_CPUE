...
# Core SQL functions:
#------------------------------------
location_sql        <-  function(surveyIN = 98,performance = TRUE ){
...
location_catch_sql        <-  function(surveyIN = 98, speciesIN = 10120 ,performance = TRUE ){
...
LWA_table_sql  <- function(surveyIN = 98, speciesIN = 10120 ,performance = TRUE ){
...
length_sql <-  function(surveyIN = 98, speciesIN = 10120,performance = TRUE ){
